...
def generateWorld(request):
    ...
    def genDescr(title):
        ...
        list2 = ["overgrown boulder", "granite door", "pair of granite doors", "broken statue", "worn statue", "pair of worn statues", "boulder", "dark cave", "murky cave", "fallen tree", "waterfall", "crypt", "broken temple", "fallen temple", "graveyard", "fallen tower"]
        list3 = ["bog", "boulder field", "cliff side", "forest", "grove", "marsh", "morass", "mountain base", "mountain range", "mountain top", "snowland", "swamp", "thicket", "wasteland", "woodlands", "woods"]
        list4 = ["large", "small", "massive", "grand", "modest", "scanty", "narrow"]
        list5 = ["broken", "clammy", "crumbling", "damp", "dank", "dark", "deteriorated", "dusty", "filthy", "foggy", "grimy", "humid", "putrid", "ragged", "shady", "timeworn", "weary", "worn"]
        list6 = ["ash", "bat droppings", "broken pottery", "broken stone", "cobwebs", "crawling insects", "dead insects", "dead vermin", "dirt", "large bones", "moss", "puddles of water", "rat droppings", "remains", "roots", "rubble", "small bones"]
        ...
        list8 = ["is a single path", "are two paths, you take the right", "are two paths, but the right is a dead end", "are two paths, you take the left", "are two paths, but the left is a dead end", "are three paths, you take the right", "are three paths, you take the left", "are three paths, you take the middle"]
        list9 = ["downwards", "onwards", "passed broken and pillaged tombs", "passed collapsed rooms and pillaged treasuries", "passed countless other pathways", "passed countless rooms", "passed long lost rooms and tombs", "passed lost treasuries, unknown rooms and armories", "passed pillaged rooms", "passed several empty rooms"]
        list10 = ["clammy", "crumbled", "damp", "dank", "dark", "dusty", "filthy", "foggy", "ghastly", "ghostly", "grimy", "humid", "putrid", "ragged", "shady", "timeworn", "weary", "worn"]
        ...
        list12 = ["advance carefully", "carefully continue", "cautiously proceed", "continue", "move", "press", "proceed", "slowly march", "slowly move", "tread"]
        list13 = ["darkness", "depths", "expanse", "mysteries", "secret passages", "secrets", "shadows"]
        list14 = ["a few more passages", "a few more rooms and passages", "countless passages", "dozens of similar rooms and passages", "many different passages", "many rooms and passages", "various different rooms and countless passages", "various passages"]
        list15 = ["A big", "A grand", "A huge", "A large", "A massive", "A mysterious", "A tall", "A thick", "A vast", "A wide", "An enormous", "An immense", "An ominous"]
        ...
        list18 = ["Ash and soot is", "Countless odd symbols are", "Countless runes are", "Dire warning messages are", "Dried blood splatters are", "Intricate carvings are", "Large claw marks are", "Messages in strange languages are", "Ominous symbols are", "Strange writing is", "Various odd symbols are"]
        ...
        list20 = ["bleak", "dark", "dire", "eerie", "foggy", "gloomy", "grim", "misty", "murky", "overcast", "shadowy", "shady", "sinister", "somber"]
        list21 = ["aged", "battered", "busted", "decayed", "demolished", "destroyed", "deteriorated", "forgotten", "frayed", "long lost", "pillaged", "tattered", "wasted", "weathered", "worn", "worn down"]
        list22 = ["absorbed", "butchered", "claimed", "consumed", "defaced", "desolated", "devoured", "dismantled", "drained", "eaten", "maimed", "mutilated", "ravaged", "ravished", "spoiled", "taken", "wiped out", "wrecked"]
